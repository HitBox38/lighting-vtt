...
export function useAllowedTokenIds(sceneId: string | null | undefined, remotePlayerId?: string | null) {
  ...
  return { isRemotePlayer, allowedTokenIds: new Set(player.tokenInstanceIds), scene };
}
