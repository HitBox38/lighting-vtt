  ...
  return (
    ...
    >
      <div>
        ...
        <h1 id="hero-title" className="my-[22px] text-[clamp(54px,6.8vw,88px)] leading-[0.99] font-medium tracking-[-4.5px] max-[1000px]:tracking-[-3px] max-[760px]:text-[clamp(48px,10vw,70px)] max-[760px]:tracking-[-2.6px]">
          Bring your
          <br />
        ...
        <div className="mt-[27px] flex flex-wrap items-center gap-[27px] max-[760px]:gap-5">
          <LandingAction placement="hero" />
          <a
            className={cn(landingTextLinkStyles, "max-[760px]:text-[13px]")}
            href="#how-it-works"
            onClick={() =>
